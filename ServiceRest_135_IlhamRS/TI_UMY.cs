...
namespace ServiceRest_135_IlhamRS
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-AUHI2QMK;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=IlhamRobb18");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-AUHI2QMK;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=IlhamRobb18");
